...
public class TestWorkbookParser {
  ...
  @Test
  public void testLessTabularExcelThrowsGracefulErrors() throws DataParserException, IOException, InvalidFormatException {
    exception.expect(DataParserException.class);
    exception.expectMessage("No headers present when headers expected on Sheet Feuil2");

    Workbook workbook = createWorkbook("/excel/TestLessTabular.xlsx");
    WorkbookParser parser = new WorkbookParser(settingsWithHeader, getContext(), workbook, "Sheet1::1");
  }
}